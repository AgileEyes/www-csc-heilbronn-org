...
const heroProps: HeroProps = {
  title: "Impressum",
  description:
    "Sollten untenstehende Angaben in jeglicher Form problematisch sein, so bitten wir, uns über einen der unten aufgeführten Kontaktmöglichkeiten zu informieren. Danke! ",
    ...
    <main className={classNames.container}>
      ...
      <div className="impressum">
        ...
        <p className={classNames.paragraph}>
          TenTen Cannabis Social Club Heilbronn e.V. <br />
          Langhansstraße 18
          <br />
          74360 Ilsfeld <br />
        </p>
        <p className={classNames.paragraph}>
          ...
          <br />
          siehe aktuelle{" "}
          <b>Vertretungsberechtigte und besondere Vertretungsbefugnis</b> im
          Registerinhalt.
        </p>
        <p className={classNames.paragraph}>
          <h2>Kontakt</h2>
          E-Mail:{" "}
          <a href="mailto:kontakt@csc-heilbronn.org">
            kontakt@csc-heilbronn.org
          </a>
          <br />
          Post: siehe oben genannte Vereinsadresse
          <br />
        </p>
        <p className={classNames.paragraph}>
          <h2>Registereintrag</h2>
          <br />
          Eintragung im Registergericht: Vereinsregister des Amtsgerichts
          Stuttgart
          <br />
          Registernummer: VR 726231
          <br />
        </p>
        <p className={classNames.paragraph}>
          <h2>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
          <br />
          siehe aktueller Vorstand im Registereintrag
        </p>
        <p className={classNames.paragraph}>
